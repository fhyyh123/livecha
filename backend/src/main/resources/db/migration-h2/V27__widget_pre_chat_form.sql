...
alter table widget_config add column if not exists pre_chat_message varchar;
alter table widget_config add column if not exists pre_chat_name_label varchar;
alter table widget_config add column if not exists pre_chat_email_label varchar;
