-- Widget script customization fields (align with docs/widget.js data-chatlive-* options)
...
alter table widget_config add column if not exists max_height_ratio double precision;
